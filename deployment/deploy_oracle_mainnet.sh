...
stakeToken=${stakeToken:-a0b86991c6218b36c1d19d4a2e9eb0ce3606eb48.factory.bridge.near} # usdsc
...
minInitialChallengeWindowDuration=${minInitialChallengeWindowDuration:-43200000000000} # 12hr
finalArbitratorInvokeAmount=${finalArbitratorInvokeAmount:-100000000000000000000000000000} # 100K FLX
