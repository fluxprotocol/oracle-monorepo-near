...
fn dr_scenario_2() {
    ...
    for i in 0..7 {
        ...
        match i % 2 == 0 {
            true => {
                ...
                let _res = init_res
                    .bob
                    .stake(0, outcome_to_stake.clone(), quarter_of_bond);
                let _res = init_res
                    .carol
                    .stake(0, outcome_to_stake.clone(), quarter_of_bond);
                let _res = init_res
                    .jasper
                    .stake(0, outcome_to_stake, quarter_of_bond * 2);
            }
            false => {
                println!(
                    "Round {}, bond size: {}, staking incorrectly with Peter",
                    i, bond_size
                );
                let outcome_to_stake =
                    Outcome::Answer(AnswerType::String("test_wrong".to_string()));
    ...
    println!(
        "Jasper has spent {} altogether on staking",
        pre_claim_difference_jasper
    );
    println!(
        "Peter has spent {} altogether on staking",
        pre_claim_difference_peter
    );

    init_res
        .treasurer
        .ft_transfer(&REQUESTER_CONTRACT_ID, 100_000);
    ...
    println!(
        "Carol gained {} from claim for a total profit of {}",
        post_stake_difference_carol, post_total_difference_carol
    );
    println!(
        "Jasper gained {} from claim for a total profit of {}",
        post_stake_difference_jasper, post_total_difference_jasper
    );
    println!(
        "Peter gained {} from claim for a total profit of {}",
        post_stake_difference_peter, post_total_difference_peter
    );
...
fn dr_scenario_3() {
    ...
    for i in 0..8 {
        ...
        match i % 2 == 0 {
            true => {
                ...
                let _res = init_res
                    .peter
                    .stake(0, outcome_to_stake.clone(), third_of_bond);
                let _res = init_res
                    .illia
                    .stake(0, outcome_to_stake.clone(), third_of_bond);
                let _res = init_res
    ...
    println!(
        "Illia has spent {} altogether on staking",
        pre_claim_difference_illia
    );
    println!(
        "Vitalik has spent {} altogether on staking",
        pre_claim_difference_vitalik
    );
    ...
    println!(
        "Peter gained {} from claim for a total loss of {}",
        post_stake_difference_peter, post_total_difference_peter
    );
    println!(
        "Illia gained {} from claim for a total loss of {}",
        post_stake_difference_illia, post_total_difference_illia
    );
    println!(
        "Vitalik gained {} from claim for a total loss of {}",
        post_stake_difference_vitalik, post_total_difference_vitalik
    );
    println!("Alice lost {} altogether", post_total_difference_alice);
}
...
fn dr_scenario_fixed_fee() {
    ...
    println!(
        "Request interface after staking: {}",
        init_res
            .alice
            .get_token_balance(Some(REQUESTER_CONTRACT_ID.to_string()))
    );
